...
import 'package:musaneda/app/modules/order/views/tabby_stc_paymentview/tabby_payment_view.dart';
...
class OrderView extends GetView<OrderController> {
                          ...
                          child: Row(
                            children: [
                              ...
                              Container(
                                ...
                                child: Center(
                                  child: Text(
                                    "${controller.packagesData.total} ${"sar"
                                        .tr}",
                                    style: TextStyle(
                                      color: MYColor.success,
                                      fontSize: 12,
                            ...
                            children: [
                              Column(
                                children: [
                                  ...
                                  const SizedBox(height: 10),
                                  Text(
                                    "${controller.packagesData.price} ${"sar"
                                        .tr}",
                                    style: TextStyle(
                                      color: MYColor.buttons,
                                      fontSize: 14,
                              ...
                              Column(
                                children: [
                                  ...
                                  const SizedBox(height: 10),
                                  Text(
                                    "${controller.packagesData.discount} ${"sar"
                                        .tr}",
                                    style: TextStyle(
                                      color: MYColor.buttons,
                                      fontSize: 14,
                              ...
                              Column(
                                children: [
                                  ...
                                  const SizedBox(height: 10),
                                  Text(
                                    "${controller.packagesData.tax} ${"sar"
                                        .tr}",
                                    style: TextStyle(
                                      color: MYColor.buttons,
                                      fontSize: 14,
  ...
  Widget myPayment(BuildContext context) {
    return GetBuilder<AmazonPayController>(
      init: AmazonPayController.I,
      builder: (ctx) =>
          ListView(
            children: [
              Container(
              ...
              Padding(
                ...
                child: TextButton(
                    onPressed: () {
                      ctx.paymentWithCreditOrDebitCard(
                          ...
                          onFailed: (error) {
                            // Dialogs.errorDialog(
                            //     context, '${'transaction_failed'.tr} $error');
                            mySnackBar(title: 'failure',
                                message: 'failure',
                          ...
                          onCancelled: () {
                            // Dialogs.errorDialog(
                            //     context, 'transaction_cancelled'.tr);
                            mySnackBar(title: 'Cancel',
                                message: 'Cancel',
                                color: MYColor.danger,
                                icon: Icons.error_outline);
                          },
                          ...
                          //     ? double.parse(
                          //     paymentController.getCoupon.data!.totalPrice!)
                          //     .toInt()
                          //     : double.parse(
                          //     controller.getSSD.data!.totalPrice!).toInt(),
              ...
              Padding(
                padding: const EdgeInsets.symmetric(vertical: 10.0),
                child: TextButton(onPressed: () {}, child: const Text('Mada')),
              ),
              Padding(
                padding: const EdgeInsets.symmetric(vertical: 10.0),
                child: TextButton(onPressed: () {

                  Get.to(const TabbyPaymentView());
              ...
              Padding(
                padding: const EdgeInsets.symmetric(vertical: 10.0),
                child: TextButton(
                    onPressed: () {}, child: const Text('STC pay')),
              ),
                    ...
                    return TextFormField(
                      ...
                      decoration: myINPUTDecoration(
                        ...
                        prefixIcon: CustomPaymentController.I.brandType.value ==
                            ...
                            : 'assets/images/${CustomPaymentController.I
                            .brandType.value.name.toUpperCase()}.png',
                      ),
                      onChanged: (value) {
      ...
      child: Container(
        ...
        child: Obx(
              ...
              CupertinoButton(
                ...
                minSize: 45,
                onPressed: () =>
                    CustomPaymentController.I.pay(
                      controller.packagesData.total,
                      false,
                    ),
                color: MYColor.white,
                borderRadius: BorderRadius.circular(10),
                child: CustomPaymentController.I.brandType.value ==
                    BrandType.none
                    ? Icon(
                  CupertinoIcons.creditcard,
                  color: MYColor.buttons,
                  ...
                  padding: const EdgeInsets.all(10),
                  child: Image.asset(
                    'assets/images/${CustomPaymentController.I.brandType.value
